...
public class IslandMaxAreaDFS {
     ...
     * @return
     */
    private static int dfs(int[][] graph, boolean[][] visited, int i, int j) {
        // 递归终止条件
        ...
        for (int[] step : dir) {
            ...
            res += dfs(graph, visited, nextI, nextJ);
        }
        return res;
    }
